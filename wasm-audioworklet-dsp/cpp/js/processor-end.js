  ...
  constructor() {
    ...
    this.port.onmessage = e => {
      if (e.data.type === 'load-processor') {
        ...
        this._inBuf = new Float32Array(Module.HEAP32.buffer, this._inPtr, this._size);
        this._outBuf = new Float32Array(Module.HEAP32.buffer, this._outPtr, this._size);
      } else {
        throw "unexpected.";
      }
    }
  ...
  process(inputs, outputs, parameters) {
    ...
    for (let channel = 0; channel < output.length; channel++) {
      ...
      if (this._outBuf.buffer.byteLength == 0) {
        ...
        this._inBuf = new Float32Array(Module.HEAP32.memory, this._inPtr, this._size);
        this._outBuf = new Float32Array(Module.HEAP32.memory, this._outPtr, this._size);
      }
